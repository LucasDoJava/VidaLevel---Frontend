...
import { useDebounce } from '../hooks/useDebounce' // Você precisará criar este hook
...
export default function MyHabits() {
  ...
  // Função para buscar hábitos (busca completa)
  const searchHabits = async (query) => {
    ...
    try {
      ...
      if (response.ok) {
        const data = await response.json()
        // Mapear os resultados do Solr para o formato esperado pelo HabitCard
  ...
  // Efeito para buscar resultados quando o usuário pressiona Enter
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                onClick={() => {
                  ...
                  // Se o hábito excluído estiver nos resultados da busca, atualizar
